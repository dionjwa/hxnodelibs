...
@:jsRequire("canvas")
extern class NodeCanvasRenderingContext2D
{
	//From node-canvas
	public function addFont(font :NodeCanvasFont) :Void;
...
.</li> <li>Gecko 9.0 (Firefox 9.0 / Thunderbird 9.0 / SeaMonkey 2.6)
 now correctly supports CORS for drawing images across domains without <a title="en/CORS_Enabled_Image#What_is_a_.22tainted.22_canvas.3F" rel="internal" href="https://developer.mozilla.org/en/CORS_Enabled_Image#What_is_a_.22tainted.22_canvas.3F">tainting the canvas</a>.</li>
	...
	@:overload( function( image : NodeCanvasImage, x : Float, y : Float ) :Void {} )
	@:overload( function( image : NodeCanvasImage, x : Float, y : Float, width : Float, height : Float ) :Void {} )
	@:overload( function( image : NodeCanvasImage, sx : Float, sy : Float, sw : Float, sh : Float, dx : Float, dy : Float, dw : Float, dh : Float ) :Void {} )
	@:overload( function( canvas : NodeCanvasImage, x : Float, y : Float ) :Void {} )
	@:overload( function( canvas : NodeCanvasImage, x : Float, y : Float, width : Float, height : Float ) :Void {} )
	@:overload( function( canvas : NodeCanvasImage, sx : Float, sy : Float, sw : Float, sh : Float, dx : Float, dy : Float, dw : Float, dh : Float ) :Void {} )
	...
	function drawImage( image : NodeCanvasImage, sx : Float, sy : Float, sw : Float, sh : Float, dx : Float, dy : Float, dw : Float, dh : Float ) : Void;

	function drawImageFromRect( image : NodeCanvasImage, ?sx : Float, ?sy : Float, ?sw : Float, ?sh : Float, ?dx : Float, ?dy : Float, ?dw : Float, ?dh : Float, ?compositeOperation : String ) : Void;
